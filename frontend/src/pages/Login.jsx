...
// Left panel — animated code typewriter
const demoLines = [
  { code: 'const solve = (arr, target) => {', color: '#1D4ED8' },
  { code: '  let left = 0, right = arr.length - 1;', color: '#374151' },
  { code: '  while (left < right) {', color: '#7C3AED' },
  { code: '    const mid = (left + right) >> 1;', color: '#374151' },
  { code: '    if (arr[mid] === target) return mid;', color: '#059669' },
  { code: '    arr[mid] < target ? left = mid+1', color: '#374151' },
  { code: '                     : right = mid-1;', color: '#374151' },
  { code: '  }', color: '#7C3AED' },
  { code: '  return -1;', color: '#DC2626' },
  { code: '};', color: '#1D4ED8' },
];
    ...
    <div className="hidden md:flex flex-col justify-center relative overflow-hidden bg-base-100 border-r"
      ...
      <div className="px-10 py-16">
        ...
        <h2 className="text-3xl font-black mb-3 leading-snug tracking-tight">
          Welcome back,<br />
          <span style={{ color: '#1D4ED8' }}>keep coding! 🚀</span>
        </h2>
        ...
        <div className="rounded-2xl p-5 font-mono text-sm leading-7 code-surface">
          <div className="flex items-center gap-1.5 mb-3">
            ...
            <span className="ml-2 text-xs opacity-40">binarySearch.js</span>
          </div>
  ...
  const inputCls = (hasError) =>
    `w-full px-4 py-3 rounded-xl border text-sm outline-none transition-all ${
      hasError
        ...
        : 'focus:border-blue-600 focus:ring-2 focus:ring-blue-600/12'
        ...
        <div className="w-full max-w-sm animate-slideUp">
          ...
          <div className="bg-base-100 rounded-2xl shadow-sm border p-8" style={{ borderColor: '#E5E7EB' }}>
            <div className="mb-7">
              ...
              <p className="text-sm" style={{ color: '#64748B' }}>Welcome back! Let's get back to solving.</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input id="login-password" type={showPassword ? "text" : "password"}
                    placeholder="••••••••" className={inputCls(errors.password)} {...register('password')} />
            ...
            <p className="text-center text-sm">
              ...
              <NavLink to="/signup" className="font-semibold transition-colors" style={{ color: '#1D4ED8' }}>
                Create one free →
              </NavLink>
            </p>
